        ...
        <div class="box-body">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" name="byCompany">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" name="costPrice">
                </div>

                <div class="form-group">
                    <label for="">Giá bán sản phẩm</label>
                    <input type="text" class="form-control" id="" name="sellingPrice">
                </div>

                <div class="form-group">
                    <label for="">Màn hình</label>
                    <input type="text" class="form-control" id="" name="screen">
                </div>

                <div class="form-group">
                    <label for="">Camera</label>
                    <input type="text" class="form-control" id="" name="camera">
                </div>

                <div class="form-group">
                    <label for="">CPU</label>
                    <input type="text" class="form-control" id="" name="CPU">
                </div>

                <div class="form-group">
                    <label for="">RAM</label>
                    <input type="text" class="form-control" id="" name="RAM">
                </div>

                <div class="form-group">
                    <label for="">ROM</label>
                    <input type="text" class="form-control" id="" name="ROM">
                </div>

                <div class="form-group">
                    <label for="">Dung lượng bin</label>
                    <input type="text" class="form-control" id="" name="battery">
                </div>

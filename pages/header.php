...
<header class="header">
                ...
                <div class="col-6 login_link">
                    <ul class="header_link right m-auto">
                        ...
                        if (isset($_SESSION['id_user'])) {
                            ...
                            <li>
                                <a href="index.php?quanly=dangXuat"><i class="fa fa-sign-out-alt mr-3"
                                        style="margin-left: 10px;"></i>Đăng xuất</a>
                            </li>
                            <?php
                        } else {
                            ?>
                            ...
                            <li>
                                <a href="index.php?quanly=dangKy"><i class="fas fa-user-plus mr-3"
                                        style="margin-left: 10px;"></i>Đăng kí</a>
                            </li>
                            <?php
                        }
                        ?>
            ...
            <div class="row">
                <div class="col-lg-3 col-100-h">
                    ...
                    <div class="logo">
                        <a href="">
                            <img width="150px"
                                src="https://firebasestorage.googleapis.com/v0/b/n7-php.appspot.com/o/logo-shop-dien-thoai-7.png?alt=media&token=cfea5d67-44e4-42fe-b97b-bbea196a7c6e"
                                alt="">
                        </a>
                    </div>
                ...
                <div class="col-lg-6 m-auto pdt15">
                    <form class="example" method="post"
                        action="index.php?quanly=showAllProduct&search=<?php echo $search ?>&page=1">
                        <input type="text" class="input-search" placeholder="Tìm kiếm.." value="<?php echo $search ?>"
                            name="search">
                        <button type="submit" value="btn" name="search-btn" class="search-btn"><i
                ...
                <div class="col-3 m-auto hidden-sm hidden-xs">
                    ...
                    <?php
                        //Đăng nhập mới xem được sản phẩm yêu thích
                        if(isset($_SESSION['id_user'])){
    ...
    <nav class="header_nav hidden-sm hidden-xs">
        <div class="container">
            <ul class="header_nav-list nav">
                <li class="header_nav-list-item">
                    <a href="index.php" class="<?php echo isset($_GET['quanly']) == null ? 'active' : '' ?>">Trang
                        chủ</a>
                </li>

                <li class="header_nav-list-item"><a href="index.php?quanly=gioithieu"
                        class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == '' ? 'active' : '' ?>">Giới
                        thiệu</a></li>
                <li class="header_nav-list-item has-mega">
                    <a href="index.php?quanly=showAllProduct&page=1"
                        class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'showAllProduct' ? 'active' : '' ?>">Sản
                        phẩm<i class="fas fa-angle-right" style="margin-left: 5px;"></i></a>
                            ...
                            <ul class="col-8 no-padding level0">
                                ...
                                <ul class="level1">
                                    ...
                                    while ($row_nhomsp = mysqli_fetch_array($query_nhomsp)) {
                                        ...
                                        <li class="level2">
                                            <a
                                                href="index.php?quanly=nhomsp&name=<?php echo $row_nhomsp['byCompany'] ?>&page=1">
            ...
            <div class="col-4">
                <a href="">
                    <picture>
                        <img src="https://firebasestorage.googleapis.com/v0/b/n7-php.appspot.com/o/banner%2Fdien-thoai-cu-vinh-long-3.png?alt=media&token=c9619c77-fd9b-4cd8-9bbe-b2b06a8ac546"
                            alt="" width="95%">
                    </picture>
                </a>
            </div>
        ...
        <li class="header_nav-list-item"><a href="index.php?quanly=news"
                class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'news' ? 'active' : '' ?>">Tin tức</a>
        </li>
        <li class="header_nav-list-item"><a href="index.php?quanly=contact"
                class="<?php echo isset($_GET['quanly']) && $_GET['quanly'] == 'contact' ? 'active' : '' ?>">Liên hệ</a>
        </li>
        </ul>
        </div>
    </nav>

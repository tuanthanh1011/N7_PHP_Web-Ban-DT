...
<body>
    <footer class="footer">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list">
                        ...
                        <li class="footer__item">
                            <p><i class="fas fa-phone-square-alt footer__item-icon"></i> Phone: <a href="tel:0123456789">0123456789</a></p>
                        </li>
                        <li class="footer__item">
                            <p><i class="fas fa-envelope-square footer__item-icon"></i> Email: <a href="mailto:abc@gmail.com">tt00200@gmail.com</a></p>
                        </li>
                        <li>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div style="display: flex;justify-content:space-between;cursor: pointer;margin-bottom: 8px;" data-toggle="collapse" data-target="#demo2">
                    ...
                    <ul class="footer__list collapse show" id="demo2">
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 1: Minh Khai, Bắc Từ Liêm, Hà Nội</a>
                        </li>
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 2: TP.Thanh Hóa, Thanh Hóa</a>
                        </li>
                        <li class="footer__item">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div style="display: flex;justify-content:space-between;cursor: pointer;margin-bottom: 8px;" data-toggle="collapse" data-target="#demo1">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div style="display: flex;justify-content:space-between;cursor: pointer;margin-bottom: 8px;" data-toggle="collapse" data-target="#demo">
        ...
        <div class="footer__bottom">
            <p class="footer__text">© Bản quyền thuộc về Smart Point Shop</p>
        </div>
    </footer>
    <div id="go-to-top">
